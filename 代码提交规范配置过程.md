...
对于代码提交规范，通过使用 husky 来监测 git hooks 钩子，通过以下插件完成对应的配置：
...
### lint-staged.config.mjs
    ...
    export default {
      '*.{vue,js,ts,mjs,cjs}': ['eslint --fix', 'prettier --write'],
      '*.{scss,less,css,styl,html}': ['prettier --write'],
